  ...
  return (
    <div style={s.container}>
      <div className="auth-card" style={s.card}>
        ...
        <p style={s.subtitle}>Sign in to continue to NoteFlow</p>
        ...
        <div style={s.divider}><span style={s.dividerText}>New to NoteFlow?</span></div>
        <Link to="/register" style={s.registerBtn}>Create an account</Link>
      </div>
    </div>
  );
}
